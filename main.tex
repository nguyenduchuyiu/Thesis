...
interpreted together with syntactic reward and downstream dependency reward. A repaired candidate
...
numbers of unused declarations while still receiving high syntactic reward, then syntactic survival is not
